...
subtitle: Chronic stress raises baseline circulating corticosterone and reduces vocal plasticity in male budgerigars, an avian model for adult vocal learning
...
if (file.exists("./.git/config")){
  ...
  cat("\nWe recomend cloning the following github repository to be able to reproduce all the analyses: [", url, "](", url, ")", sep = "")
  }
